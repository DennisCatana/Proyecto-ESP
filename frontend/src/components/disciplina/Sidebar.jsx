...
>>>>>>> Stashed changes
              ...
              {collapsed && (
                <span className="absolute left-full top-1/2 -translate-y-1/2 ml-2 whitespace-nowrap bg-slate-900 text-white text-sm px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition">
                  {item.label}
                </span>
              )}
            </li>
