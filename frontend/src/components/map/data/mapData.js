...
export const ubicaciones = {
    1: [
        { id: 1, nombre: "Bloque de Aula N.º 2", x: 15, y: 20, descripcion: "Aulas para clases teóricas de 2.º año. Cuenta con capacidad para 80 personas y está equipado con modernas instalaciones educativas.", capacidad: "80 personas", horario: "07:00 - 18:00", imagenes: ["/images/image5.jpeg", "/images/image6.jpeg"] },
        { id: 2, nombre: "Dormitorios de 2.º año", x: 25, y: 35, descripcion: "Dormitorios del segundo año de formación. Instalaciones adecuadas para 45 cadetes.", capacidad: "45 camas", horario: "24 horas", imagenes: ["/images/image5.jpeg"] },
        { id: 3, nombre: "Pelotón femenino", x: 40, y: 25, descripcion: "Alojamiento exclusivo para personal femenino de la institución.", capacidad: "30 camas", horario: "24 horas", imagenes: ["/images/image6.jpeg"] },
        { id: 4, nombre: "Dormitorios de 1.º año", x: 30, y: 50, descripcion: "Dormitorios del primer año de formación policial.", capacidad: "50 camas", horario: "24 horas", imagenes: ["/images/image5.jpeg"] },
        { id: 5, nombre: "Bloque de Aulas N.º 1", x: 20, y: 65, descripcion: "Aulas principales y laboratorio de informática. Centro de formación académica.", capacidad: "100 personas", horario: "07:00 - 20:00", imagenes: ["/images/image5.jpeg", "/images/image6.jpeg"] },
        { id: 6, nombre: "Patio de la Lealtad", x: 55, y: 40, descripcion: "Espacio ceremonial y formación. Sede de actos importantes.", capacidad: "500 personas", horario: "06:00 - 22:00", imagenes: ["/images/image9.jpeg"] },
        { id: 7, nombre: "Dormitorios de 3.º y 4.º año", x: 60, y: 55, descripcion: "Dormitorios de cadetes superiores en su etapa final de formación.", capacidad: "60 camas", horario: "24 horas", imagenes: ["/images/image5.jpeg"] },
        { id: 8, nombre: "Comedor", x: 75, y: 45, descripcion: "Comedor principal de la institución con capacidad para 200 comensales.", capacidad: "200 personas", horario: "06:00 - 21:00", imagenes: ["/images/image7.jpeg"] },
        { id: 9, nombre: "Patio de la Tradición", x: 80, y: 65, descripcion: "Museo al aire libre y ceremonias tradicionales de la institución.", capacidad: "300 personas", horario: "07:00 - 18:00", imagenes: ["/images/image9.jpeg"] }
    ],
    2: [
        ...
        { id: 6, nombre: "Villas de las Sras. y Sres. Oficiales", x: 75, y: 30, descripcion: "Complejo residencial para oficiales y sus familias.", capacidad: "20 familias", horario: "24 horas", imagenes: ["/images/image7.jpeg"] },
        { id: 7, nombre: "Casa Blanca", x: 85, y: 55, descripcion: "Residencia oficial del Director y eventos especiales.", capacidad: "50 personas", horario: "08:00 - 20:00", imagenes: ["/images/image7.jpeg"] }
    ],
    3: [
